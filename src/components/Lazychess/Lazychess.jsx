...
export const Lazychess = () => {
  return (
    <div className={styles.page}>
      ...
      <iframe className={styles.iframe} frameborder="0" src="https://itch.io/embed-upload/11346584?color=333333" allowfullscreen="" width="450" height="870"><a href="https://jadenleung.itch.io/lazy-chess">Play Lazy Chess on itch.io</a></iframe>
      </div>
