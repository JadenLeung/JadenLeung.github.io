...
export const Chess = () => {
  return (
    <div className={styles.page}>
      ...
      <iframe className={styles.iframe} frameborder="0" src="https://itch.io/embed-upload/11331056?color=333333" allowfullscreen="" width="450" height="870"><a href="https://jadenleung.itch.io/ai-chess">Play AI Plays: Chess on itch.io</a></iframe>
      </div>
